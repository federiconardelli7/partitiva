...
export const params2026 = defineParams({
  ...
  dipendente: {
    ...
    sommaIntegrativa: {
      ...
      fonte: {
        riferimento:
          'L. 207/2024, art. 1, c. 4-5: somma che NON concorre al reddito, per reddito complessivo ≤ 20.000, pari al 7,1/5,3/4,8% del reddito di lavoro dipendente (fasce 8.500/15.000; percentuale individuata sul reddito annualizzato — qui anno intero); circ. AdE 4/E/2025, §1.1',
    ...
    fondoPensione: {
      valore: { lavoratore: 0.0055, datore: 0.0155, plafondCents: 530_000 },
      fonte: {
        riferimento:
          'CCNL Terziario Confcommercio, art. 107 (invariato dal rinnovo 22/03/2024): lavoratore min 0,55% e datore 1,55% della retribuzione utile TFR (qui ≈ RAL); deducibilità entro il plafond ex art. 8, c. 4, D.Lgs. 252/2005 — 5.300 € dal 2026 (L. 199/2025, art. 1, c. 201); il TFR conferito NON consuma il plafond',
